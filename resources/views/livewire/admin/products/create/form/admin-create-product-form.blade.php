<div class="bg-base-200 rounded-lg shadow h-full w-3/4 py-4 mt-7" x-show="currentStep === 1" x-transition.500ms>
    <div class="grid grid-cols-8 grid-rows-4 h-full">
        ...
        <div class="col-start-8 row-start-4 flex items-center justify-center">
            <button class="btn btn-outline btn-sm" @if ($errors->any()) disabled @endif x-on:click="currentStep++">
